...
wp_enqueue_script('prettyPhoto', TOPNEWS_VENDOR . '/formstone/js/jquery.prettyPhoto.js', array('jquery'), false, true);
...
// Formstone
wp_enqueue_script('formstone-core', TOPNEWS_VENDOR . '/formstone/js/core.js', array('jquery'), false, true);
wp_enqueue_script('formstone-touch', TOPNEWS_VENDOR . '/formstone/js/touch.js', array('jquery'), false, true);
wp_enqueue_script('transition', TOPNEWS_VENDOR . '/formstone/js/transition.js', array('jquery'), false, true);


//Isotope
wp_enqueue_script('isotope', TOPNEWS_VENDOR . '/isotope/isotope.pkgd.min.js', array('jquery'), false, true);

// Animated.css
wp_enqueue_style('animate', TOPNEWS_VENDOR . '/animate.css/animate.min.css');

//WowJS
wp_enqueue_script('wow', TOPNEWS_VENDOR . '/wow/wow.min.js', array('jquery'), false, true);
