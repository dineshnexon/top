...
if (function_exists('cs_get_option')):
    if (is_page()){
        ...
        $category_template_sidebar_option_1_id = cs_get_option( 'category_template_sidebar_option_1_'.$this_cat_id );
        $category_template_sidebar_option_1 = cs_get_option( 'category_template_sidebar_option_1');
        if(!empty($category_template_sidebar_option_1_id)) {
            $top_news_sidebar_meta_field = cs_get_option( 'category_template_sidebar_option_1_'.$this_cat_id );
        } else if (!empty($category_template_sidebar_option_1)){
            $top_news_sidebar_meta_field = cs_get_option( 'page_sidebar_option_1' );
        } else {
            $top_news_sidebar_meta_field = cs_get_option( 'page_sidebar_option_1' );
        }
