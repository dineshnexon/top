...
if (function_exists('cs_get_option')):
    ...
    $top_news_use_theme_option = @$top_news_page_option_meta_data['use_theme_option'];
    
    if ($top_news_use_theme_option == '1'){
        ...
        $top_news_featured_post_grid = @$top_news_page_option_meta_data['page_featured_post_grid'];
        $top_news_featured_post_layout = @$top_news_page_option_meta_data['page_featured_post_layout'];        
        $top_news_featured_post_limit = @$top_news_page_option_meta_data['page_featured_post_limit'];
        $top_news_featured_post_from = @$top_news_page_option_meta_data['page_featured_post_from'];
        $top_news_featured_category = @$top_news_page_option_meta_data['page_featured_posts_cat'];
        $top_news_featured_tag = @$top_news_page_option_meta_data['page_featured_posts_tag'];
    }
